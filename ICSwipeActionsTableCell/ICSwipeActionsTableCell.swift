...
public protocol ICSwipeActionsTableCellDelegate : NSObjectProtocol {
  func swipeCellButtonPressedWithTitle(title: String, indexPath: NSIndexPath, sender: ICSwipeActionsTableCell)
}
...
public class ICSwipeActionsTableCell: UITableViewCell {
  ...
  public func hideButtons(animated animated: Bool) {
  ...
  internal func buttonTouchUpInside(sender: UIButton) {
    if delegate != nil {
      ...
      if indexPath != nil {
        self.delegate!.swipeCellButtonPressedWithTitle(sender.titleLabel!.text!, indexPath: indexPath!, sender: self)
      }
    }
  }
